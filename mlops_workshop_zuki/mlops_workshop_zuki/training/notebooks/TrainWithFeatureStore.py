...
# ``mlops_workshop_zuki/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_workshop_zuki-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_workshop_zuki.mlops_workshop_zuki-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_workshop_zuki.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_workshop_zuki.trip_dropoff_features",
